...
Sudos = {sudoid,1118246568,1118246568}
Sudo_Id = 1118246568
function Bot(msg)  
local idbot = false  
...
if text == "/start" then 
local bl = '*◾أهلا بك في صانع بوتات الحماية 👋🏻 ،\n\n◽البوت مقدم من قناة »* [. 𝖲𝗈𝗎𝗋𝖼𝖾 yousef TeAm >](t.me/lB8BBB1) \n\n*◾يمكنك الان صنع بوت واحد فقط من صانع البوتات\n\n     عليك استخدام اوامر التحكم اسفل وبدء الانشاء🔻\n⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*\n[⚙️꒐ Gruop The Suport Maker .](https://t.me/lB8BBB1)'
...
- الصانع مقدم من قناة ( @lB8BBB ) مجاناً 
...
• تاريخ الانشاء :* ( `2022/6/27` )
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯
- قناة شروحات السورس : @O0lO00 .
